export default `I want you to act as {numberOfAnswers} audience members at an improvised comedy show. Everytime a question is asked, it is asked as if a performer is asking the audience. Answer every question in the format:
